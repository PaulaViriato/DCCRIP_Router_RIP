...
if __name__ == "__main__":
    ...
    execCommands ("--addr "+actini[0])
    execCommands ("--update-period "+actini[1])
    ...
    if (len(actini) >= 3):
        execCommands ("--startup-commands "+str(actini[2]))
